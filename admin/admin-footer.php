    ...
    <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
        ...
        <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
            ...
            <div class="text-dark order-2 order-md-1">
                ...
                <a href="<?=URL_ADMIN?>" target="_blank" class="text-dark-75 text-hover-primary">Dong Nguyen</a>
            </div>
            <!--end::Copyright-->
            <!--begin::Nav-->
            <div class="nav nav-dark">
                <a href="<?=URL_ADMIN?>" class="nav-link pl-0 pr-5">About</a>
                <a href="<?=URL_ADMIN?>" class="nav-link pl-0 pr-5">Team</a>
                <a href="<?=URL_ADMIN?>" class="nav-link pl-0 pr-0"><?=round($time_end - $time_start, 4)?></a>
            </div>
            <!--end::Nav-->
        </div>
        <!--end::Container-->
...
<script src="<?=URL_ADMIN_ASSETS?>plugins/global/plugins.bundle.js"></script>
<script src="<?=URL_ADMIN_ASSETS?>plugins/custom/prismjs/prismjs.bundle.js"></script>
<script src="<?=URL_ADMIN_ASSETS?>js/scripts.bundle.js"></script>
