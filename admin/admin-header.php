...
<head>
    ...
    <link href="<?=URL_ADMIN_ASSETS?>plugins/global/plugins.bundle.css" rel="stylesheet" type="text/css" />
    <link href="<?=URL_ADMIN_ASSETS?>plugins/custom/prismjs/prismjs.bundle.css" rel="stylesheet" type="text/css" />
    <link href="<?=URL_ADMIN_ASSETS?>css/style.bundle.css" rel="stylesheet" type="text/css" />
    <!--end::Global Theme Styles-->
    <!--begin::Layout Themes(used by all pages)-->
    <link href="<?=URL_ADMIN_ASSETS?>css/themes/layout/header/base/light.css" rel="stylesheet" type="text/css" />
    <link href="<?=URL_ADMIN_ASSETS?>css/themes/layout/header/menu/light.css" rel="stylesheet" type="text/css" />
    <link href="<?=URL_ADMIN_ASSETS?>css/themes/layout/brand/dark.css" rel="stylesheet" type="text/css" />
    <link href="<?=URL_ADMIN_ASSETS?>css/themes/layout/aside/dark.css" rel="stylesheet" type="text/css" />
    <!--end::Layout Themes-->
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        <!--begin::Logo-->
        <a href="<?=URL_ADMIN?>"><img alt="Logo" src="<?=get_config('logo')?>" style="max-height: 60px" /></a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
        ...
        <div class="d-flex flex-row flex-column-fluid page">
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="brand flex-column-auto" id="kt_brand">
                    <!--begin::Logo-->
                    <a href="<?=URL_ADMIN?>" class="brand-logo">
                        <img alt="Logo" src="<?=get_config('logo')?>" style="max-height: 35px" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Toggle-->
                            ...
                            <div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
                                ...
                                <ul class="menu-nav">
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="<?=URL_HOME?>" class="menu-link">
                                            <span class="menu-text">Trang Chủ</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="<?=URL_ADMIN?>" class="menu-link">
                        ...
                        <div class="topbar">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                                    <form>
                                        <!--begin::Header-->
                                        <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(<?=URL_ADMIN_ASSETS?>/media/misc/bg-1.jpg)">
                                            <!--begin::Title-->
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                                    <!--begin:Header-->
                                    <div class="d-flex flex-column flex-center py-10 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(<?=URL_ADMIN_ASSETS?>/media/misc/bg-1.jpg)">
                            ...
                            <div class="topbar-item">
                                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                                    ...
                                    <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?=$me['user_name']?></span>
