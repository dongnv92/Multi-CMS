                            ...
                            <div class="card-inner p-0">
                                <table class="table table-tranx table-hover">
                                    ...
                                    <tr class="tb-tnx-head">
                                        ...
                                        <th style="width: 15%" class="text-center align-middle">Đơn giá/Lít</th>
                                        <th style="width: 15%" class="text-center align-middle">Người thêm</th>
                                    ...
                                    foreach ($data['data'] AS $row){
                                        ...
                                        <tr class="tb-tnx-item">
                                            <td class="text-left align-middle">Xe <strong class="text-pink"><?=$get_car['data']['meta_name']?></strong> đổ dầu ngày <strong class="text-pink"><?=date('d/m/Y', strtotime($row['caroil_date']))?></strong></td>
