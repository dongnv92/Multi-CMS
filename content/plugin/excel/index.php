                        ...
                        <div class="card-title-group">
                            <div class="card-tools">
                                ...
                                <div class="form-inline flex-nowrap gx-3">
                                    <div class="form-wrap">
                                        <textarea class="form-control" name="test"><?=($_REQUEST['test'] ? $_REQUEST['test'] : '')?></textarea>
                                    </div>
                                    <div class="btn-wrap">
                                        <span class="d-none d-md-block">
                                            <br />
                                            <button type="submit" name="submit" value="submit" class="btn btn-primary">LỌC DỮ LIỆU</button>
                                        </span>
                                    </div>
                                </div>
                                <?=formClose()?>
            ...
            <?php if($_REQUEST['submit']){?>
                <div class="card card-bordered">
                    <div class="card-inner border-bottom">
                        ...
                        $content = explode("\n", $content);
                        $content = $excel->Calculator($path[3], $content);
                        ?>
                        <table class="table table-responsive">
                            ...
                            <tr>
                                <td><?=$i?></td>
                                <td><?=$_content['product_name']?></td>
                                <td><?=$_content['amout']?></td>
                            </tr>
                            <?php
                            }
                            ?>
                ...
                <div class="card-inner">
                    ...
                    if($success){
                        ...
                        foreach ($data AS $_data){
                            ...
                            $_REQUEST['excel_bill']         = $_data[0];
                            $_REQUEST['excel_bks']          = '';
                            $_REQUEST['excel_atd']          = '';
                            $_REQUEST['excel_date_move']    = '';
                            $_REQUEST['excel_shopname']     = '';
                            $_REQUEST['excel_address']      = '';
                            $_REQUEST['excel_district']     = '';
                            $_REQUEST['excel_product_name'] = trim($_data[10]);
                            $_REQUEST['excel_amount']       = $_data[16];
                            $_REQUEST['excel_weight']       = '';
                            $_REQUEST['excel_price']        = '';
                            $excel->add_row();
                        }
                        ?>
                    <?php }?>
            ...
            <div class="card-inner border-bottom">
                ...
                <div class="card-inner">
                    ...
                    foreach ($list_file_upload AS $_list_file_upload){
                        echo '- <a href="'. URL_ADMIN .'/excel/filter/'. $_list_file_upload .'">'. $_list_file_upload .'</a><hr />';
                    }
                    ?>
                </div>
            </div>
